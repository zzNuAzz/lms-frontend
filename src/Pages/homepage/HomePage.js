    ...
    <div className={classes.root}>
      <Grid container spacing={3} xs={12} style={{marginTop: "40px"}}>
        ...
        <Grid item xs={12} lg={6}
              container
              alignItems="center">
          <img item src="https://www.hifivework.com/images/bgDiscover.png" style={{width: "100%"}}></img>
        </Grid>
        <Grid container style={{marginTop: "40px"}}>
          <Grid item xs={12} lg={4}
            ...
            <IconButton item aria-label="delete">
              <PersonIcon item className={classes.large}></PersonIcon>
            </IconButton>
          ...
          <Grid item xs={12} lg={4}
                ...
                direction="column">
            <IconButton item aria-label="delete">
              <CloudIcon item className={classes.large}></CloudIcon>
            </IconButton>
          ...
          <Grid item xs={12} lg={4}
                ...
                direction="column">
            <IconButton item aria-label="delete">
              <FaceIcon item className={classes.large}></FaceIcon>
            </IconButton>
